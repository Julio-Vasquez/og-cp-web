    ...
    <div className='bg-purple'>
      <div className='stars'>
        ...
        <div className='central-body'>
          <img className='image-404' src={error404} width='300px' alt='text 404' />
          <Link to={RP.login} className='btn-go-home'>
            {formatMessage({ id: 'link.home' })}
          </Link>
        </div>
        <div className='object'>
          <img className='object_rocket' src={rocket} width='40px' alt='cohete' />
          <div className='earth-moon'>
            <img
              ...
              alt='planeta tierra'
            />
            <img className='object_moon' src={moon} width='80px' alt='la luna' />
          </div>
